...
public enum InstitutionType {
    ...
    Fuel_Station("Fuel Station", InstitutionCategory.FUEL_DISPENSOR),
    CTB_Country_Office("SLTB Head Office", InstitutionCategory.FUEL_DISPENSOR),
    CTB_Head_Office("SLTB Regional Office", InstitutionCategory.FUEL_DISPENSOR),
    CTB_Depot("SLTB Depot", InstitutionCategory.FUEL_DISPENSOR),
    ...
    CPC_Head_Office("CPC Headoffice", InstitutionCategory.FUEL_DISPENSOR),
    CPC_Provincial_Office("CPC Provincial Office", InstitutionCategory.FUEL_DISPENSOR),
    CPC_Depot("CPC Depot", InstitutionCategory.FUEL_DISPENSOR),
